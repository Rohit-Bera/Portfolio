  ...
  const experience = [
    {
      ...
      projectTitle: "My Fresh Meal Store",
      myperformance:
          ...
          <div className="about-hero-part2">
            ...
            <div className="aboutme-container">
              ...
              <p>
                ...
                who has interest in creating and showcasing his artwork through
                <span
                  style={{
                    fontSize: "1.2rem",
                    color: "white",
            ...
            <section className="edu-2">
              ...
              <div className="edu-div-2">
                ...
                <section className="masters-3">
                  ...
                  <div>
                    <label>
                      Participated in Azadi ka Amrit Mahostsav Hackathon - 2022
                    </label>
                  </div>
                </section>
              </div>
